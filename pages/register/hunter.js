...
const RegisterHunter = () => {
	...
	const [secondarySkillSearchResults, setSecondarySkillSearchResults] = useState([]);
	...
	return (
		<>
			...
			>
				...
				<progress className="progress progress-primary bg-transparent w-full" value={page} max={6} />
				...
				<div className="flex flex-col mt-10">
					<AnimatePresence mode="wait">
								...
								<div className="max-w-lg mt-5">
									<div className="flex flex-col bg-base-200 p-3 rounded-btn">
										...
										<div className="flex justify-end mt-10">
											<button
												disabled={
													!(inputData.email && inputData.password && inputData.confirmPassword) ||
							...
							>
								...
								<div className="max-w-lg mt-5">
									<div className="flex flex-col bg-base-200 p-3 rounded-btn">
										...
										<label htmlFor="bio" className="mt-2 w-full flex justify-between">
											<span>Bio</span>
										...
										<div className="flex justify-between mt-10">
											...
											<button
												disabled={!(inputData.fullName.first && inputData.fullName.last && inputData.bio)}
												onClick={() => {
													setPage(page + 1);
													window.scrollBy({
														top: -window.innerHeight,
								...
								<div className="max-w-lg mt-5">
									<div className="flex flex-col bg-base-200 p-3 rounded-btn">
										...
										<div className="relative">
											...
											<input
												...
												onInput={(e) => {
													...
													if (value.length > 0) {
														const filtered = Cities.filter((c) => c.city.toLowerCase().includes(value.toLowerCase()));
														...
														{citySearchResults.map((c, i) => (
															<div
																...
																onClick={() => {
																	...
																	setCitySearchResults([]);
																	document.getElementById("address.city").value = c.city;
																}}
															>
																<span>{c.city}</span>
															</div>
										...
										<input
											...
											onInput={(e) => {
												// format with dashes
												const formatted = e.target.value.replace(/(\d{4})(\d{3})(\d{4})/, "$1-$2-$3").replace(/-$/, "");
										...
										<div className="flex justify-between mt-10">
											...
											<button
												disabled={
													!(inputData.address.address && inputData.address.city && inputData.address.postalCode) ||
						...
						{page === 4 && (
							<motion.div variants={__PageTransition} initial="initial" animate="animate" exit="exit">
								...
								<div className="max-w-lg mt-5">
									<div className="flex flex-col bg-base-200 p-3 rounded-btn">
														...
														{primarySkillSearchResults.map((c, i) => (
															<div
																...
																onClick={() => {
																	...
																	setPrimarySkillSearchResults([]);
																	document.getElementById("PrimarySkill").value = c;
																}}
															>
																<span>{c}</span>
															</div>
														...
														{secondarySkillSearchResults.map((c, i) => (
															<div
																...
																onClick={() => {
																	setInputData({
																		...inputData,
																		skillSecondary: [...inputData.skillSecondary, c],
																	});
																	setSecondarySkillSearchResults([]);
													...
													{inputData.skillSecondary.map((c, i) => (
														<div
															...
															onClick={() => {
																setInputData({
																	...inputData,
																	skillSecondary: inputData.skillSecondary.filter((s) => s !== c),
																});
										...
										<div className="flex justify-between mt-10">
											...
											<button
												disabled={inputData.skillPrimary === "" || inputData.skillSecondary.length === 0}
												className="btn btn-primary"
												onClick={() => {
													handleSubmit();
												}}
						...
						{page === 5 && (
							<motion.div variants={__PageTransition} initial="initial" animate="animate" exit="exit">
								<p className="text-xl font-bold">Please wait while we process your application</p>
