	...
	return (
		<>
			...
			>
				...
				<progress className="progress progress-primary bg-transparent w-full" value={page} max={4} />

				<div className="flex flex-col mt-10">
					<AnimatePresence mode="wait">
						{page === 1 && (
							<motion.div key="1" variants={__PageTransition} initial="initial" animate="animate" exit="exit">
						...
						{page === 2 && (
							<motion.div key="2" variants={__PageTransition} initial="initial" animate="animate" exit="exit">
						...
						{page === 3 && (
							<motion.div key="3" variants={__PageTransition} initial="initial" animate="animate" exit="exit">
								...
								<div className="max-w-lg mt-5">
									<div className="flex flex-col bg-base-200 p-3 rounded-btn">
										...
										<div className="flex justify-between mt-10">
											...
											<button
												disabled={inputData.shortDescription === "" || inputData.fullDescription === ""}
												className="btn btn-primary"
						...
						{page === 4 && (
							<motion.div key="4" variants={__PageTransition} initial="initial" animate="animate" exit="exit">
