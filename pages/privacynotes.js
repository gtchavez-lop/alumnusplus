...
const PrivacyNotesPage = () => {
  return (
    ...
    >
      ...
      <p>
        This data privacy notice explains how Wicket Journeys collects, uses,
        and shares personal data when you use our website,
        https://www.wicket.vercel.app, and other online services.
      </p>
      ...
      <ul className="list-disc pl-10">
        ...
        <li>
          To communicate with you, such as to send you newsletters or updates
        </li>
      ...
      <p>
        We may share your personal data with third parties for the following
        purposes:
      </p>

      <ul className="list-disc pl-10">
        <li>
          To service providers who help us provide and improve our services
        </li>
      ...
      <p>
        We may update this data privacy notice from time to time. We will post
        any updates on this page, so please check back regularly.
      </p>
    </motion.main>
  );
};
