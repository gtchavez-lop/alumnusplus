	...
	return (
		<>
			...
			>
					...
					<span className="text-primary relative">
						<AnimatePresence>
							<motion.span
								...
								className="absolute top-0 lg:left-2 w-max font-bold bg-clip-text text-transparent bg-gradient-to-r to-primary from-secondary"
							>
								{activeJob}?
							</motion.span>
						</AnimatePresence>
				...
				>
					<FiArrowDown className={`text-3xl ${scrollYValue > 200 && "rotate-180"} duration-200`} />
				</motion.div>
			</motion.div>
			...
			>
				...
				>
					<img src="/landing/Experts-cuate.svg" className="w-[500px] h-[300px] lg:hidden" alt="" />
					<h4 className="text-2xl font-bold">Providing jobs for ordinary people.</h4>
					<p className="text-sm opacity-70">Today, in every way, I am capable of saying &apos;I can!&apos;</p>
				</motion.div>
			...
			<motion.div ref={desktopImg_2} className="relative flex flex-col items-center min-h-[70vh] px-2 lg:px-0 mb-16">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10">
					...
					>
						<img src="/landing/Connecting-teams-cuate.svg" className="w-[250px]" alt="" />
					...
					<motion.div
						...
						className="flex flex-col items-center p-5"
					>
						<img src="/landing/Marketing-cuate.svg" className="w-[250px]" alt="" />
					...
					>
						<img src="/landing/Connected-world-cuate.svg" className="w-[250px]" alt="" />
			...
			<motion.div className="relative flex flex-col items-center justify-center min-h-[50vh] px-2 lg:px-0">
				...
				<div className="flex flex-col items-center justify-center">
					<h2 className="text-center font-bold text-3xl">Start your journey with us</h2>
					<p className="text-center text-sm opacity-70">Join us now and create your future with us</p>
